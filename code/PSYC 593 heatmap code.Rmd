...
heatmap_function <- function(data, subject_num = NULL, trial_num = NULL) {
  ...
  graph <- ggplot(heatmap_df, aes(x = x, y = y, fill = density)) +
    ...
    scale_alpha(range = c(0, 0.4), guide = "none") +  # Set alpha scale; 0 for no density
    ...
    geom_rect(data = heatmap_df, aes(xmin = target_x-20, xmax = target_x+20, ymin = target_y-20, ymax = target_y+20), 
