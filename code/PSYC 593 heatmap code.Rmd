...
#fixation_graph <- fixation_order_function(cleaned_data_fv, 1, 15)
...
video_plot_function <- function(data, subject_num = NULL, trial_num = NULL, et_data, raw_et) {
  ...
  # do one trial, and sample timepoints every 50 rows
  ...
  #TODO: can't seem to change fps, maybe it's a gif limitation? also the dimensions look wrong on my screen
    animate(graph,nframes = 400, fps = 100, duration = 4, height = 960, width = 540)      
  return(graph)
}
...
video <- video_plot_function(cleaned_data_fv, 36, 25, trials_df, et_data)
